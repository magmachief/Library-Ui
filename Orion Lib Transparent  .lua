		...
		local function GetElements(Container)
			...
			function ElementFunction:AddSlider(sliderConfig)
				...
				function slider:Set(val)
					...
					OrionLib.Animate(sliderDrag, {Size = UDim2.fromScale((self.Value - sliderConfig.Min) / (sliderConfig.Max - sliderConfig.Min), 1)}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
			...
			function ElementFunction:AddDropdown(dropdownConfig)
				...
				function dropdown:Set(val)
					if not table.find(dropdown.Options, val) then
						...
						for _, btn in pairs(dropdown.Buttons) do
							OrionLib.Animate(btn, {BackgroundTransparency = 1}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
							OrionLib.Animate(btn.Title, {TextTransparency = 0.4}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
						end
						return
					end
					dropdown.Value = val
					...
					OrionLib.Animate(dropdown.Buttons[val], {BackgroundTransparency = 0}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
					OrionLib.Animate(dropdown.Buttons[val].Title, {TextTransparency = 0}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
					return dropdownConfig.Callback(dropdown.Value)
				end
				AddConnection(click.MouseButton1Click, function()
					dropdown.Toggled = not dropdown.Toggled
					dropdownFrame.F.Line.Visible = dropdown.Toggled
					OrionLib.Animate(dropdownFrame.F.Ico, {Rotation = dropdown.Toggled and 180 or 0}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
					if #dropdown.Options > maxElements then
						OrionLib.Animate(dropdownFrame, {Size = dropdown.Toggled and UDim2.new(1,0,0,38 + (maxElements * 28)) or UDim2.new(1,0,0,38)}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
					else
						OrionLib.Animate(dropdownFrame, {Size = dropdown.Toggled and UDim2.new(1,0,0, dropdownList.AbsoluteContentSize.Y + 38) or UDim2.new(1,0,0,38)}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
					end
				end)
			...
			function ElementFunction:AddBind(bindConfig)
				...
				AddConnection(bindBox.Value:GetPropertyChangedSignal("Text"), function()
					OrionLib.Animate(bindBox, {Size = UDim2.new(0, bindBox.Value.TextBounds.X + 16, 0, 24)}, 0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
				end)
			...
			function ElementFunction:AddTextbox(textboxConfig)
				...
				AddConnection(textboxActual:GetPropertyChangedSignal("Text"), function()
					OrionLib.Animate(textContainer, {Size = UDim2.new(0, textboxActual.TextBounds.X + 16, 0, 24)}, 0.45, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
				end)
			...
			function ElementFunction:AddColorpicker(colorpickerConfig)
				...
				AddConnection(click.MouseButton1Click, function()
					...
					OrionLib.Animate(colorpickerFrame, {Size = colorpicker.Toggled and UDim2.new(1,0,0,148) or UDim2.new(1,0,0,38)}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
